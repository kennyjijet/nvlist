...
public final class NovelPrefs {
	...
	public static final Preference<String>  ENGINE_MIN_VERSION = newPreference("vn.engineMinVersion", "1.0", "Engine Minimum Version", "The minimum allowable version of NVList that can be used to read your novel. Raises an error if the current version is less than the required version.");		
	public static final Preference<String>  ENGINE_TARGET_VERSION = newPreference("vn.engineTargetVersion", "2.7", "Engine Target Version", "The version of NVList this VN was created for.");		
