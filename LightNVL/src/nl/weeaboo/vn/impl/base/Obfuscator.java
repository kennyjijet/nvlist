...
public final class Obfuscator extends AbstractXORObfuscator {
	...
	public static final Set<String> shouldCompress = new HashSet<String>(Arrays.asList(
		"ktx", "ttf"
	));	
	public static final Set<String> unencryptables = new HashSet<String>(Arrays.asList(
