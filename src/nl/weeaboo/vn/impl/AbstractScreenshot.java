...
public abstract class AbstractScreenshot implements IScreenshot {
	...
	//Setters
	protected void setPixels(int[] argb, int w, int h, int screenWidth, int screenHeight) {
	...
	protected void setVolatilePixels(ITexture tex, int screenWidth, int screenHeight) {
