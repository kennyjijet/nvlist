...
paragraph.start("test", 4); paragraph.append("Text with "); embedded(); paragraph.append(" code"); paragraph.finish()
paragraph.start("test", 5); paragraph.append("Text with "); embedded("["); paragraph.append(" code"); paragraph.finish()
paragraph.start("test", 6); paragraph.append("Text with {tag a,b,c,d} embedded {/tag} text tags"); paragraph.finish()
